...
const Banner = () => {
  return (
    <div id='sale' className='min-h-[650px] pt-[300px] flex justify-center items-center py-8 sm:py-0 dark:bg-gray-900 dark:text-white duration-200 relative z-40' >
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center '>
          ...
          <div className='flex flex-col justify-center gap-6 sm:pt-0'>
            ...
            <div className='flex flex-col gap-4 '>
              ...
              <div data-aos="fade-up-left" data-aos-delay="600" className='flex transition-all duration-200 gap-4 items-center'>
              <IoFastFood  className='text-4xl h-12 w-12 shadow-sm p-4 mr-2 rounded-full bg-yellow-100 dark:bg-yellow-400'/>
              <p >Fast Delivery</p>
              </div>
              <div data-aos="fade-up-left" data-aos-delay="800" className='flex transition-all duration-200 gap-4 items-center'>
              <GiFoodTruck  className='text-4xl h-12 w-12 shadow-sm p-4 mr-2 rounded-full bg-green-100 dark:bg-green-400'/>
              <p>Easy Payment method</p>
              </div>
              <div data-aos="fade-up-left" data-aos-delay="1000" className='flex transition-all duration-200 gap-4 items-center'>
